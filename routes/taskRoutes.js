...
const EmployeeTask= require("../models/EmployeeTask.js"); // Task model using require
const TaskUpdate = require("../models/EmployeeTaskUpdates.js"); // TaskUpdate model using require
const multer = require("multer"); // For file uploads using require
...
router.get("/tasks", async (req, res) => {
  try {
    const employeeId = req.user.id; // Make sure authentication middleware sets req.user
